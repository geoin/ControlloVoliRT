...
/**********************************************************/
{
    double azels[MAXOBS*2]/*,dop[4]*/,vv; // FRANCO
    int i,ns;
...
static int estpos(const obsd_t *obs, int n, const double *rs, const double *dts,
                  ...
                  double *resp, char *msg, double* dop)
/********************************************************************************/
{
...
/*************************************************************/
    ...
    for (i=0;i<n;i++) {
        ...
        if (!estpos(obs_e,n-1,rs_e,dts_e,vare_e,svh_e,nav,opt,&sol_e,azel_e,
                    vsat_e,resp_e,msg_e, dop)) { // FRANCO
...
/************************** FRANCO *************************************/
    stat=estpos(obs,n,rs,dts,var,svh,nav,&opt_,sol,azel_,vsat,resp,msg, dop);
/*************************************************************************/
