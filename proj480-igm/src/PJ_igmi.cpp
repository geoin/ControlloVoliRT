/*----------------------------------------------------------------------------
!   Filename:  PJ_IGMI.CPP
!
!   Contents:	IGMI grids manager
!strcmp
...
/******************
	...
	PJ_datum_set.c : definita la variabile igmgrids e la chiamata a igmgridinit
	PJ_init.c : aggiunta la chiamata a igmgriddealloc
	PJ_transform.c : aggiunta opzione al parser e chiamata a pj_apply_igmgridshift
	PJ_utils.c : aggiunta voce per il parser
	proj_api.h : aggiunta extern per pj_apply_igmgridshift
	projects.h : definita la costante PJD_IGMGRIDSHIFT e la variabile Mygrid
*******************/
